...
"""
    ...
    # Make the toolbox panel responsive by adjusting the ratio dynamically
    layout["body"]["left"].split(
        Layout(name="user_info", size=12),  # User Info takes up 12 lines
        Layout(name="toolbox", ratio=10)  # Increased ratio for the toolbox panel for better responsiveness
    )
