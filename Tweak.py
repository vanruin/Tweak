...
def is_code_approved(code):
    ...
    try:
        response = requests.get("https://raw.githubusercontent.com/vanruin/Tweak-Approval/refs/heads/main/Approval")
...
def generate_and_check_code():
    ...
    if is_code_approved(code):
        ...
        warn_msg = Text.assemble(
           ...
           ("PLEASE SEND IT TO: ", "blue"),
           ("https://www.facebook.com/profile.php?id=100078043222260", "bold cyan")
)
